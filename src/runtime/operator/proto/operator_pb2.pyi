...
class SkippedOutcomeV2(_message.Message):
    __slots__ = ("reason", "metadata_json")
    REASON_FIELD_NUMBER: _ClassVar[int]
    METADATA_JSON_FIELD_NUMBER: _ClassVar[int]
    reason: str
    metadata_json: str
    def __init__(self, reason: _Optional[str] = ..., metadata_json: _Optional[str] = ...) -> None: ...

class NodeSnapshotV2(_message.Message):
    __slots__ = ("node_id", "name", "node_type", "status", "started_at", "ended_at", "revision", "error", "running_elapsed_seconds", "trace", "activity_continuation", "skip")
    NODE_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
