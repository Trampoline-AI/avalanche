...
class StartRunRequest(_message.Message):
    __slots__ = ("flow_name", "input_json", "context_json", "input_files", "input_s3_files", "workflow_selector")
    ...
    def __init__(self, flow_name: _Optional[str] = ..., input_json: _Optional[str] = ..., context_json: _Optional[str] = ..., input_files: _Optional[_Iterable[_Union[FileAttachment, _Mapping]]] = ..., input_s3_files: _Optional[_Iterable[_Union[S3FileReference, _Mapping]]] = ..., workflow_selector: _Optional[str] = ...) -> None: ...
