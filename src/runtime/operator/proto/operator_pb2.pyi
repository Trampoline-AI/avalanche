...
class GetWorkflowNodeSourceRequestV2(_message.Message):
    ...
    node_id: str
    def __init__(self, workflow_selector: _Optional[str] = ..., node_id: _Optional[str] = ...) -> None: ...
...
class FlowInfoV2(_message.Message):
    __slots__ = ("workflow_selector", "display_name", "manifest_digest", "node_ids", "workflow_id", "file_path", "topology", "agent_node_ids", "agent_metadata_json", "cron", "next_run_at", "last_run_at", "webhook_path", "webhook_url", "webhook_active", "classifier_metadata_json")
...
class WorkflowTopologyV2(_message.Message):
    __slots__ = ("node_ids", "graph", "node_types", "display_names", "agent_field_schemas_json", "agent_instruction_lines", "standard_step_docstring_lines", "classifier_metadata_json")
