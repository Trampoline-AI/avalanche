...
class WorkflowReloadStatus(_message.Message):
    __slots__ = ("reloading",)
...
class OperatorUpdate(_message.Message):
    __slots__ = ("sequence", "run_created", "run_status_changed", "node_status_changed", "log_appended", "agent_event_appended", "trace_finalized", "catalog_replaced", "workflow_reload_status")
    SEQUENCE_FIELD_NUMBER: _ClassVar[int]
    ...
    WORKFLOW_RELOAD_STATUS_FIELD_NUMBER: _ClassVar[int]
    sequence: int
