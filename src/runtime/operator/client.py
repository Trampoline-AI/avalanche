...
class _ProjectSummaryCursorGuard:
    """Keep one live run-summary source continuous across a page chain."""
    ...
    def validate(self, page: pb.RunSummaryPageV2) -> None:
        ...
        # Checkpoint metadata describes this page observation and may change.
        # Comparing against the preceding page prevents a later head rewind.
